...
Print color and Discord bot colors are in utils/colors.py, and can be used by importing the class and using DiscordColors.RED in for example, embeds.
...
To use this with an online server hoster, you might have to modify the path in utils/config.py!
